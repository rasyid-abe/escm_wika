                ...
                if ($sh < 1) {
                    ...
                    for($row=1; $row<=$highestRow; $row++)
                    {
                        ...
                        $arr_ppm = [
                            ...
                            'ppm_subject_of_work' => $worksheet->getCellByColumnAndRow(3, $row)->getValue(),
                        ...
                        $arr_ppi = [
                            ...
                            'ppi_code' => $worksheet->getCellByColumnAndRow(18, $row)->getValue(),
                        ...
                        $arr_ppv = [
                            'ppv_smbd_code' => $worksheet->getCellByColumnAndRow(18, $row)->getValue(),
                        ...
                        $arr_ppm_pr = [
                            ...
                            'pr_subject_of_work' => $worksheet->getCellByColumnAndRow(0, $row)->getValue() . ' - ' . $worksheet->getCellByColumnAndRow(3, $row)->getValue(),
        ...
        for ($i=2; $i < count($datas); $i++) {
            if (count($datas[$i]) != 1) {
                ...
                $arr_ppm_pr = [
                    ...
                    'pr_subject_of_work' => $datas[$i][0] . ' - ' . $datas[$i][3],
        ...
        for ($i=0; $i < count($ppm); $i++) {
            ...
            if ($pr_id->num_rows() > 0) {
                ...
                $it_id = $this->db->get_where('prc_plan_item', [
                    ...
                    'ppi_pr_order' => $ppi[$i]['ppi_pr_order']
                ]);
                ...
                if ($it_id->num_rows() > 0) {
                    ...
                    $this->db->where('ppi_pr_order', $ppi[$i]['ppi_pr_order']);
                    ...
                    $this->db->where('ppi_pr_order', $ppi_pr[$i]['ppi_pr_order']);

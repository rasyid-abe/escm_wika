...
$data['total'] = $this->Contract_m->getPekerjaanAmandemen($id,$userdata['employee_id'])->num_rows();
...
$rows = $this->Contract_m->getPekerjaanAmandemen($id,$userdata['employee_id'])->result_array();

...
$activity_id = (!empty($last_comment['activity'])) ? $last_comment['activity'] : $activity_id;

$activity = $this->Procedure2_m->getActivity($activity_id)->row_array();

$wo = $this->Contract_m->getDataWOMatgis($wo_id)->row_array();
...
$x = $this->Contract_m->getWOMatgisItem("",$wo_id)->result_array();
...
$data["comment_list"][0] = $this->Comment_m->getWOMatgis($wo_id)->result_array();

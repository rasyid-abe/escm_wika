...
$view = 'contract/proses_work_order/proses_si_matgis_v';
...
$activity_id = $this->Settings_m->get_settings_num('_ACT_SI_MATGIS_CREATE');
...
if(empty($last_comment)){
	...
	$data=$this->Contract_m->getDataSIMatgis($id)->row_array();
	$x = $this->Contract_m->getSIMatgisItem("",$id)->result_array(); //item data
}

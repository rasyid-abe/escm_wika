...
$view = 'tiket/permintaan_tiket/detail_penerimaan_tiket_v';
...
$data['item3'] = $this->Tikplan_m->getItemPenerimaanTiket("",$id)->result_array();

$this->template($view,"Detail Penerimaan Tiket",$data);
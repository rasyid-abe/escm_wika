...
class PrivyBAKP extends CI_Controller {
    ...
    public function send_message_wa($rfqNo,$privyId,$fullname,$numberTo)
    {
        ...
        $url_request = base_url()."uskep_online/privyBAKP/".$rfqNo."/".$privyId;
        $message = "hello ".$fullname.", SISTEM BAKP sudah di share. untuk melalakukan e-sign, cek link berikut : ".$url_request;
    ...
    public function upload_doc($rfqId)
    {
        ...
        $dataUploadPrivy['title'] = "Test Document Upload and Share BAKP";
        ...
        if($res->status == "SUCCESS")
        {
            ...
            foreach ($contact as $key => $value) {
                ...
                $notif['url'] = "uskep_online/privyBAKP/".$rfqId."/".$value['privy'];
    ...
    public function save_doc($rfqNo)
    {
        ...
        $doc = json_decode($getDataUskep['bakp_status_esign']);
        ...
        $output_filename = "privy/bakp/bakp_".$rfqNo.".pdf";
        $host = $url;

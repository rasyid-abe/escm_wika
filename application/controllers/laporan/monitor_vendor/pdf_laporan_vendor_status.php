 ...
 <br>
     <table style="width:100%;margin-top:30px;">
          <tr>
            ...
            <td colspan="4" style="padding: 2px 0px 2px 0px;text-align:center;height=100px;font-size:14px;font-weight:bold;">Laporan Status Vendor '.$report_dist_dept.'</td>
...
$content_table .= 
    '
     <tr>
      ...
      <td style="text-align:center">'.$rpo['end_date']  .'</td>
...
$data['namePDF'] = "Laporan Status Vendor.pdf";

...
$this->db->trans_begin();
  ...
  else
  {
    ...
    if (!$exists) {
      ...
      $hasil_mutu_pekerjaan = array("vk_id"=>$get_id,"vks_parameter"=>"hasil_mutu_pekerjaan","vks_score"=> $post['score_hasil_mutu_pekerjaan'],"created_datetime"=>date('Y-m-d h:i:s'));
      array_push($kompilasi_score, $hasil_mutu_pekerjaan);
      
      $score_k3l = array("vk_id"=>$get_id,"vks_parameter"=>"k3l","vks_score"=> $post['score_k3l'],"created_datetime"=>date('Y-m-d h:i:s'));
      array_push($kompilasi_score, $score_k3l);
      
      $score_5r = array("vk_id"=>$get_id,"vks_parameter"=>"5r","vks_score"=> $post['score_5r'],"created_datetime"=>date('Y-m-d h:i:s'));
      array_push($kompilasi_score, $score_5r);
      
      $pengamanan = array("vk_id"=>$get_id,"vks_parameter"=>"pengamanan","vks_score"=> $post['score_pengamanan'],"created_datetime"=>date('Y-m-d h:i:s'));
      array_push($kompilasi_score, $pengamanan);
      ...
      $hasil_mutu_pekerjaan = array("vks_id"=>$post['mutu_pekerjaan_id'],"vk_id"=>$prev_data['vk_id'],"vks_parameter"=>"hasil_mutu_pekerjaan","vks_score"=> $post['score_hasil_mutu_pekerjaan'],"created_datetime"=>date('Y-m-d h:i:s'));
      array_push($kompilasi_score, $hasil_mutu_pekerjaan);
      
      $score_k3l = array("vks_id"=>$post['k3l_id'],"vk_id"=>$prev_data['vk_id'],"vks_parameter"=>"k3l","vks_score"=> $post['score_k3l'],"created_datetime"=>date('Y-m-d h:i:s'));
      array_push($kompilasi_score, $score_k3l);
      
      $score_5r = array("vks_id"=>$post['id_5r'],"vk_id"=>$prev_data['vk_id'],"vks_parameter"=>"5r","vks_score"=> $post['score_5r'],"created_datetime"=>date('Y-m-d h:i:s'));
      array_push($kompilasi_score, $score_5r);
      
      $pengamanan = array("vks_id"=>$post['pengamanan_id'],"vk_id"=>$prev_data['vk_id'],"vks_parameter"=>"pengamanan","vks_score"=> $post['score_pengamanan'],"created_datetime"=>date('Y-m-d h:i:s'));
      array_push($kompilasi_score, $pengamanan);

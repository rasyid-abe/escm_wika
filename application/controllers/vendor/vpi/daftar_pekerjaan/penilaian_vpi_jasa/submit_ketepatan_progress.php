<?php 
 ...
 $post= $this->input->post();
  ...
  $data['vpkp_value_attach'] = (isset($post['nilai_attachment_inp']) AND !empty($post['nilai_attachment_inp'])) ? $post['nilai_attachment_inp'] : "";
  ...
  if ($this->form_validation->run() == FALSE){
    ...
    $this->vpi('daftar_pekerjaan','penilaian_vpi',$data['vvh_id'],'jasa','ketepatan_progress');

  <?php 
  $view = 'pemaketan/drup/pembuatan_drup_v';
...
$sum_anggaran = $this->db->select_sum('(volume * harga_satuan)', 'total_anggaran');
$sum_anggaran = $this->db->where('pemilik_program', $userdata['dept_name']);
$sum_anggaran = $this->db->get('prc_proses_drup')->row_array();
$data['drup_anggaran'] = $sum_anggaran;
$data['is_drup'] = true;
...
$this->session->unset_userdata("code_group");
  ...
  $this->template($view, "Pembuatan Pengadaan DRUP", $data);

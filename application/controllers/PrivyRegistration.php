...
class PrivyRegistration extends CI_Controller {
    ...
    public function registration()
    {
        ...
        foreach ($listTtd as $key => $value) {
            ...
            if($usr != null)
            {
                ...
                if((count($listTtd) - 1) == $key)
                {
                    ...
                    $recipientsBAKP[$key]['pos_x'] = 320;
                    $recipientsBAKP[$key]['pos_y'] = $pos_y_bakp + 200;
                    $recipientsBAKP[$key]['page'] = $page - 2;

                    // $recipientsDepkn[$key]['identifier'] = $usr['signer_id'];
                    // $recipientsDepkn[$key]['type'] = 'signer';
                    // $recipientsDepkn[$key]['pos_x'] = 320;
                    // $recipientsDepkn[$key]['pos_y'] = $pos_y_bakp;
                    // $recipientsDepkn[$key]['page'] = $page;
                }
                
                // $recipientsBAKP[$key]['identifier'] = $usr['signer_id'];
                // $recipientsBAKP[$key]['type'] = 'signer';
                // $recipientsBAKP[$key]['pos_x'] = 320;
                // $recipientsBAKP[$key]['pos_y'] = $pos_y_bakp;
                // $recipientsBAKP[$key]['page'] = $page - 2;
                ...
                if((count($listTtd) - 1) == $key)
                {
                    $recipients_wa = [
                        [
                            'number' =>"0895338684277", //$usr['handphone_1'] != null ? str_replace("62","0",$usr['handphone_1']) : "0"  ,
                            'name' => $usr['nm_peg'],
                            'privy'=> $usr['signer_id']
        ...
        $mergeRecipients = array_merge($recipientsBAKP,$recipientsDepkn);
        $mergeRecipients = array_merge($mergeRecipients,$recipientsPenilaian);
    ...
    {
        $output_filename = "privy/bakp/PRIVY_BAKP_".$rfqNo.".pdf";

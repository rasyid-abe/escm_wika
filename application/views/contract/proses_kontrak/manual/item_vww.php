                ...
                <div class="col-sm-8">
                  <div class="input-group align-items-center">
                    <span class="input-group-btn">
                      <button type="button" data-id="doc_attachment_inp_" data-folder="<?php echo "contract/pengadaan/paket" ?>" data-preview="preview_file_" class="btn btn-sm btn-info upload btn-bordered">
                        <i class="fa fa-cloud-upload"></i> Up
                      </button>
                      <button type="button" data-url="<?php echo site_url('log/download_attachment/contract/pengadaan/paket/' . $curval) ?>" class="btn btn-sm btn-info preview_upload mr-1 btn-bordered" id="preview_file_">
                        <i class="fa fa-share"></i> View
                      </button>
                    </span>
                    <input readonly type="text" class="form-control" id="doc_attachment_inp_" name="lampiran_item" value="<?php echo $curval ?>">
                    <span class="input-group-btn">
                      <button type="button" data-id="doc_attachment_inp_" data-folder="<?php echo "contract/pengadaan/paket" ?>" data-preview="preview_file_" class="btn btn-sm btn-danger removefile ml-1 btn-bordered">
            ...
            <table class="table" id="item_table">
              <thead>
                <tr>
                  ...
                  <th>HPS</th>
                  <th>Subtotal HPS</th>
                  <th>Lampirannnnnnn</th>
                  <th><a href="#">blablabla</a></th>
                </tr>
              </thead>
              <tbody>
                <?php
  ...
  $(document).ready(function() {
    ...
    $(".action_item").click(function() {
      ...
      if (harga_satuan_int < 1) {
        ...
        html += "<td><input type='hidden' class='doc_attachment_inp_' data-no='" + no + "' name='doc_attachment_inp_[" + no + "]' value='" + doc_attachment_inp_ + "'/>" + doc_attachment_inp_ + "</td>";

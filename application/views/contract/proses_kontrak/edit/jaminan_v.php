    ...
    <div class="card">
      ...
      <div class="card-header border-bottom pb-2">
        ...
        <div class="btn-group-sm float-right position-relative" id="showButtonJaminan" style="display: none;">
          ...
          <a class="btn btn-sm empty_jaminan btn-trash" title="Hapus"><i class="ft-trash"></i></a>
      ...
      <div class="card-content">
        <div class="card-body">
                  ...
                  <div class="col-sm-7">
                    ...
                    <div class="input-group">
                      <span class="input-group-btn">
                        <button type="button" data-id="jaminan_file_inp" data-folder="<?php echo "contract/jaminan" ?>" data-preview="preview_file" class="btn btn-info upload mr-1" title="Upload"><i class="ft-upload"></i></button>
                      </span>
                      <input readonly type="text" class="form-control mr-1" id="jaminan_file_inp" name="jaminan_file_inp" value="<?php echo $curval ?>">
          ...
          <div class="table-responsive">
            <table class="table" id="jaminan_table">
              <thead>
                <tr>
                  <th>No</th>
                  <th>Jenis Jaminan</th>
...
<script>
  $(document).ready(function () {
    ...
    $('#tgl_mulai_inp').val($("#mulai_inp :hidden").val());
    $('#tgl_akhir_inp').val($("#akhir_inp :hidden").val());
    ...
    $("#DateFrom").dxDateBox({
            ...
            onValueChanged: function (e) {
                ...
                $('#mulai_berlaku_inp').val($("#DateFrom :hidden").val());
                $('#berlaku_hingga_inp').val($("#DateTo :hidden").val());
...
//   $('#mulai_berlaku_inp').datetimepicker({
//   format: 'YYYY/MM/DD',
//  }).show();
//  $('#berlaku_hingga_inp').datetimepicker({
//   format: 'YYYY/MM/DD',
//  }).show();

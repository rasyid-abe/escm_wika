    ...
    <div class="col-12">
        <div class="card">
            ...
            <?php else: ?>
                <div class="card-header border-bottom pb-2">
                    <div class="btn-group-sm float-left">
                        <span class="card-title text-bold-600 mr-2">Daftar Sumber Daya</span>
                    </div>
                </div>
            <?php endif; ?>
                                ...
                                if (isset($aitem) && !empty($aitem)) {
                                    foreach ($aitem as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <input type="hidden" value="<?php echo (int)str_replace(".", "", $value[1]) * $value[0] ?>" name="item_subtotal[]" data-no="<?php echo $idnya ?>" class="subtotal_item">
                                                <?php echo inttomoney((int)str_replace(".", "", $value[1]) * $value[0]) ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <input type="hidden" name="subtotalhps[]" id="subhps<?= $idnya ?>" value="<?php echo $value[2] * $value[0] ?>" class="hpss">
                                                <?php echo inttomoney($value[2] * $value[0]) ?>
                                            </td>
                                        ...
                                        <?php
                                        $subtotal += (int)str_replace(".", "", $value[1]) * $value['ppi_is_sap'];
                                        $subtotalhps += $value[2] * $value[0];
                                    }
                                } ?>

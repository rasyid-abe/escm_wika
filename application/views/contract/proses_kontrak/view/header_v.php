    ...
    <div class="row pl-3">
      ...
      <div class="row pl-3">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-8">
                      <select class="form-control bg-select" required name="item_kontrak_inp">
                          <option value="<?php echo $curval ?>"><?php echo $curval ?></option>
                      </select>
                  </div>
              </div>
          <?php else: ?>
        ...
        <div class="col pt-4 mt-3">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-8">
                      <select class="form-control bg-select" name="kategori_pekerjaan_inp">
                          <option value="<?php echo $kontrak['kategori_pekerjaan']?>"><?php echo $kontrak['kategori_pekerjaan']?></option>
                      </select>
                  </div>
              </div>
          <?php else: ?>
          ...
          <?php if ($activity_id >= 2901 && $kontrak['is_push_contract'] == 0) : ?>
            <div class="form-group">
              <input type="hidden" id="contract_id" value="<?= $kontrak['contract_id'] ?>">
            <label class="col-sm-4 control-label text-left text-bold-700">Sync Contract</label>
            <div class="col-sm-6">
            <p><button type="button" onclick="post_vnd_contract()" class="btn btn-primary" data-bs-toggle="button" aria-pressed="false" autocomplete="off">Sync</button>  </p>
            </div>
          </div>
          <?php endif; ?>
          ...
          <div class="form-group" style="display:none;">
            <label class="col-sm-4 control-label text-left">Tanggal Penandatanganan</label>
            <div class="col-sm-6">
                <p class="form-control-static"> : <?php echo date("d/m/Y",strtotime($curval)) ?></p>
            </div>
          </div>
      ...
      <?php if (isset($read)): ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9 mt-2">
              <input class="form-control" style="background-color:#fff;color:#606060;" name="subject_work" value="<?php echo $curval ?>" readonly />
            </div>
          </div>

          <?php $curval = (isset($kontrak['scope_work'])) ? $kontrak['scope_work'] : set_value("scope_work"); ?>
          <div class="form-group">
            <label class="col-sm-2 ml-3 control-label text-left pt-2 text-bold-700">Deskripsi</label>
            <div class="col-sm-9 pt-2">
                <textarea class="form-control richtext" required name="scope_work_inp"><?php echo $curval ?></textarea>
            </div>
          </div>

          <?php $curval = (isset($kontrak['ctr_scope'])) ? $kontrak['ctr_scope'] : set_value("ctr_scope"); ?>
          <div class="form-group">
            <label class="col-sm-2 ml-3 control-label text-left pt-2 text-bold-700">Ruang Lingup</label>
            <div class="col-sm-9 pt-2">
      ...
      <?php else: ?>
          ...
          <div class="form-group">
            <label class="col-sm-2 mt-2 ml-3 control-label text-left text-bold-700">Paket Pengadaan</label>
            <div class="col-sm-9 mt-2">
              <input class="form-control" style="background-color:#fff;color:#606060;" name="subject_work" value="<?php echo $curval ?>" <?php echo $activity_id == 2027 ? 'readonly' : '' ?> />
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9 pt-2">
                <textarea class="form-control richtext" required name="scope_work_inp" placeholder="Deskripsi pengadaan" <?php echo $activity_id == 2027 ? 'readonly' : '' ?>><?php echo $curval ?></textarea>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9 pt-2">
                <textarea class="form-control richtext" required name="ctr_scope" <?php echo $activity_id == 2027 ? 'readonly' : '' ?>><?php echo $curval ?></textarea>
            </div>
          </div>

  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-header border-bottom pb-2">
        ...
        <div class="btn-group-sm float-right position-relative" id="showButtonTermin" style="display: none">
  ...
  $(document).ready(function() {
    ...
    $(".action_milestone").click(function() {
      ...
      if (deskripsi == "") {
        ...
        html += "<td class='text-center money'><input type='hidden' class='nilai_milestone' data-no='" + no + "' name='nilai_milestone[" + no + "]' value='" + nilai_milestone + "'/>" + nilai_milestone + "</td>";
        html += "<td class='text-center money'><input type='hidden' class='bobot_milestone' data-no='" + no + "' name='bobot_milestone[" + no + "]' value='" + bobot + "'/>" + bobot + "</td>";

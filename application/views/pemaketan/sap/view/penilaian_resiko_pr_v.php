    ...
    <table class="table table-striped" id="category">
      ...
      ?>
          <tr id="value">
            ...
            <td>
              <?php echo $value['category_risiko'] ?>
            </td>            
            <td>
              ...
              <?php foreach ($skala_resiko_nilai as $k => $val) {
                ...
                <div class='col-sm-10 border-bottom py-1 childed'><?php echo $val['skala_resiko'] ?></div>
              <?php }
              } ?>
              </>">
                Skala Risiko
            ...
            <td id="nilai_skala">
              <?php echo $value['nilai_risiko'] ?>
            </td>
            <td id="skala_bobot" class="bobot-<?php echo $myId ?>">
              <?php echo $value['bobot_risiko'] ?>
            </td>
            <td id="nilaixbobot" class="sum-<?php echo $myId ?>">
              <?php echo $value['total_nilai_bobot'] ?>
            </td>
          </tr>
      <?php
        }
...
<script>
  ...
  dataSumTable.each(function() {
    sumNilai += getnum($(this).find("td:eq(3)").text());
  });

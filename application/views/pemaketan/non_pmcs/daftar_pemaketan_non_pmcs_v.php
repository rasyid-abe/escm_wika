    ...
    <div class="col-12">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <a href="<?= base_url() ?>paket_pengadaan/paket_proyek_non_pmcs/pembuatan_permintaan_pengadaan" class="btn btn-info" style="border-radius: 10px;">
...
<script type="text/javascript">
    ...
    function operateFormatter(value, row, index) {
        var link = "<?php echo site_url('paket_pengadaan/paket_proyek_non_pmcs') ?>";
        return [
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $table_permintaan_pengadaan.bootstrapTable({
            url: "<?php echo site_url('paket_pengadaan/data_permintaan_pengadaan_non_pmcs') ?>",

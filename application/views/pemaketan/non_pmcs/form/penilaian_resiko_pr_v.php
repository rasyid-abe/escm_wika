        ...
        <tr id="value">
          ...
          <td>
            <span style="display: flex;">
              ...
              <button type="button" style="max-width: 60px" data-id="doc_attachment_inp_drup_jasa_<?= $key ?>" data-folder="procurement/tender" data-preview="preview_file_drup_<?= $key ?>" class="btn btn-info upload btn-sm btn-action-edit">
                <i class="fa fa-cloud-upload"></i> Up
              </button>
              <button type="button" style="border-radius: 0;" data-url="<?php echo site_url('log/download_attachment/procurement/tender/' . $curval) ?>" class="btn btn-info btn-sm preview_upload" id="preview_file_drup_<?= $key ?>">
        ...
        <tr id="value">
          ...
          <td>
            <span style="display: flex;">
              ...
              <button type="button" style="max-width: 60px" data-id="doc_attachment_inp_drup_barang_<?= $key ?>" data-folder="procurement/tender" data-preview="preview_file_barang_<?= $key ?>" class="btn btn-info upload btn-sm btn-action-edit">
                <i class="fa fa-cloud-upload"></i> Up
              </button>
              <button type="button" style="border-radius: 0;" data-url="<?php echo site_url('log/download_attachment/procurement/tender/' . $curval) ?>" class="btn btn-info btn-sm preview_upload" id="preview_file_barang_<?= $key ?>">
                <i class="fa fa-share"></i>
              </button>

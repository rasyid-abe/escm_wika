...
<script>
    ...
    function getRisiko() {
        $.ajax({
            url: '<?= site_url($controller_name . "/get_list_risiko/" . $uris); ?>',
            method: 'post',
            dataType: 'json',
            success: function(res) {
                ...
                for (i = 0; i < res.data.length; i++) {
                    html = html + "<tr>" +
                        ...
                        "<td><input type='hidden' id='kategori' data-no=" + no + " value=" + res.data[i].kategori + ">" + res.data[i].kategori + "</td>" +
                        "<td><input type='hidden' id='risiko' data-no=" + no + " value=" + res.data[i].risiko + ">" + res.data[i].risiko + "</td>" +
                        "<td><input type='hidden' id='penyebab' data-no=" + no + " value=" + res.data[i].penyebab + ">" + res.data[i].penyebab + "</td>" +
                        "<td><input type='hidden' id='dampak' data-no=" + no + " value=" + res.data[i].dampak + ">" + res.data[i].dampak + "</td>" +
                        "<td><input type='hidden' id='rating_probabilitas' data-no=" + no + " value=" + res.data[i].rating_probabilitas + ">" + res.data[i].rating_probabilitas + "</td>" +
                        "<td><input type='hidden' id='rating_dampak' data-no=" + no + " value=" + res.data[i].rating_dampak + ">" + res.data[i].rating_dampak + "</td>" +
                        "<td><input type='hidden' id='level_risiko' data-no=" + no + " value=" + res.data[i].level_risiko + ">" + res.data[i].level_risiko + "</td>" +
                        "<td><input type='hidden' id='mitigasi' data-no=" + no + " value=" + res.data[i].mitigasi + ">" + res.data[i].mitigasi + "</td>" +
    ...
    $('.action_risiko').click(function() {
        ...
        if (rs_kategori === '' || rs_risiko === '' || rs_penyebab === '' ||
            ...
            if (id_edit == "") {
                <?php $url_save = site_url($controller_name . "/save_list_risiko/" . $uris); ?>
                fetch("<?= $url_save ?>", {
                        body: formData,
                        method: "post"
                    })
                ...
                <?php $url_edit = site_url($controller_name . "/edit_list_risiko/" . $uris); ?>
    ...
    function onDeleteRisiko(params) {
        ...
        if (confirm(cf) === true) {
            <?php $url_delete = site_url($controller_name . "/delete_list_risiko"); ?>
            var fd = new FormData();
            fd.append('id', params);

<div class="wrapper wrapper-content animated fadeInRight">
  <form method="post" action="<?php echo site_url($controller_name . "/submit_pembuatan_permintaan_pengadaan"); ?>" class="form-horizontal ajaxform">
    <input type="hidden" id="tipe_perencanaan" value="non_pmcs" name="tipe_perencanaan">

    <?php
    foreach ($content as $key => $value) {
      include(VIEWPATH . "pemaketan/non_pmcs/" . $value['awc_type'] . "/" . $value['awc_file'] . ".php");
    }
    ...
    <div class="card">
      <div class="card-content">
        <div class="card-body">
          <?php echo buttonsubmit('paket_pengadaan/paket_proyek_non_pmcs', lang('back'), lang('save')) ?>
        </div>
      </div>
    </div>

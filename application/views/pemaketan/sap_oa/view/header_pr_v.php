        ...
        <div class="card-content">
          <div class="card-body row">
            <div class="col-md-6">
              ...
              <?php $curval = $permintaan['pr_dept_name']; ?>
              <div class="row form-group col-md-12">
              ...
              <?php $curval = $permintaans['pr_doc_type']; ?>
              <div class="row form-group col-md-12">
                <label class="col-sm-4 control-label">Type PO</label>
                <div class="col-sm-8">
                  <p class="form-control-static"><?php echo ": " . $curval ?></p>
                </div>
              </div>
              ...
              if (!empty($curval)) { ?>                
                <div class="row form-group col-md-12">
                  ...
                  <div class="col-sm-8">
                    <p class="form-control-static" id="deskripsi_pekerjaan"><?php echo ": " . $permintaan['pr_spk_code'] . ' - ' . $permintaan['pr_project_name'] ?></p>
            ...
            <div class="col-md-6">
              ...
              <?php $curval = $permintaan["pr_pagu_anggaran"]; ?>
              <div class="row form-group col-md-12">
                <label class="col-sm-4 control-label">Total Anggaran</label>
                <div class="col-sm-8">
                  <p class="form-control-static" id="pr_pagu_anggaran"><?php echo ": " . $curval ?></p>

                </div>
              </div>

              <?php $curval = $permintaan["pr_sisa_anggaran"]; ?>
              <div class="row form-group col-md-12">
                <label class="col-sm-4 control-label">Sisa Anggaran</label>
                <div class="col-sm-8">
                  <p class="form-control-static" id="pr_sisa_anggaran"><?php echo ": " . $curval ?></p>

          ...
          <div class="row mb-2" id="addSumberDaya" style="display: none;">
            ...
            <div class="col-md">
              ...
              <div class="row form-group col-md-12">
                ...
                <?php $curval = set_value("doc_attachment_inp_smbd_drup[$k]"); ?>
                <div class="col-sm-8">
                  <div class="input-group">
                    <span class="input-group-btn">
                      <button type="button" data-id="doc_attachment_inp_smbd_drup" data-folder="procurement/tender" data-preview="preview_file" class="btn btn-info upload rounded">
                    ...
                    <input readonly type="text" class="form-control" id="doc_attachment_inp_smbd_drup" name="doc_attachment_inp_smbd_drup" value="<?php echo $curval ?>">
                    <span class="input-group-btn">
                      <button type="button" data-id="doc_attachment_inp_smbd_drup" data-folder="procurement/tender" data-preview="preview_file" class="btn btn-danger removefile rounded ml-1">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $(".action_item_sumberdaya").click(function() {
      ...
      var doc_attachment_inp_smbd_drup = $('#doc_attachment_inp_smbd_drup').val();
      ...
      if (harga_satuan_int < 1) {
        ...
        html += "<td><input type='hidden' class='doc_attachment_inp_smbd_drup' data-no='" + no + "' name='doc_attachment_inp_smbd_drup[" + no + "]' value='" + doc_attachment_inp_smbd_drup + "'/>"
                + "<a href='"+ document.location.origin + '/log/download_attachment/pemaketan/' + doc_attachment_inp_smbd_drup +"'>"+ doc_attachment_inp_smbd_drup + "</a></td>";
        ...
        $('#sumber_hps').val("");
        $('#hps').val("");
        $('#doc_attachment_inp_smbd_drup').val("");
        $("#tipe_item").text("");
        $("#deskripsi_item").text("");
        $("#max_volume").html("");
        $("#jumlah_item_inp").val("");
    ...
    $(document.body).on("click", ".edit_item", function() {
      ...
      var doc_attachment_inp_smbd_drup = $(".doc_attachment_inp_smbd_drup[data-no='" + no + "']").val();
      ...
      $('#hps').val(hps);
      $('#doc_attachment_inp_smbd_drup').val(doc_attachment_inp_smbd_drup);

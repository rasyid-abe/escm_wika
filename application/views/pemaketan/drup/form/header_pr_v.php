        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md">
              ...
              <input type="hidden" class="form-control" name="nama_pekerjaan" id="nama_pekerjaan" value="0" readonly>
              <input type="hidden" name="perencanaan_pengadaan_inp" value="0" id="perencanaan_pengadaan_inp" />
              <input type="hidden" class="form-control" name="spk_code" id="kode_spk" value="0" disabled>
              <input type="hidden" class="form-control" name="nama_pekerjaan" id="nama_proyek" value="0" disabled>
            ...
            <div class="col-md">
              ...
              <div class="col-md-12 form-group row">
                <?php $curval = (isset($permintaan['pr_pagu_anggaran'])) ? $permintaan["pr_pagu_anggaran"] : $drup_anggaran['total_anggaran']; ?>
                ...
                <div class="col-sm-8">
                  ...
                  <input type="hidden" id="pagu_anggaran_inp" value="<?= $curval ?>"></input>
                </div>
              </div>

              <?php $curval = (isset($permintaan['pr_sisa_anggaran'])) ? $permintaan['pr_sisa_anggaran'] : $drup_anggaran['total_anggaran'] ?>
              <div class="col-md-12 form-group row">
                <label class="col-sm-4 control-label">Sisa Anggaran</label>
                <div class="col-sm-8">
                  <p class="form-control-static" id="sisa_anggaran"><?= inttomoney($curval) ?></p>
                  <input type="hidden" id="sisa_anggaran_inp" value="<?= $curval ?>"></input>
                </div>
              </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    <?php  } else { ?>
      ...
      $("#kode_spk_div").hide();
    <?php } ?>
    var item_int_btn_url = "<?php echo site_url('Paket_pengadaan/get_picker_sumberdaya_drup') ?>";
    if ($('#kode_spk').val() != '') {

...
<div class="card">
  <div class="card-header">
    <span class="card-title">
      Penilaian Risiko <?= $permintaans['pr_type_pengadaan'] ?>
    ...
    <table class="table table-striped" id="category">
      ...
      ?>
          <tr id="value">
            ...
            <td>
              <!-- <div style="color:  #2AACE3;">
            </div> -->
              <a href="<?= site_url('log/download_attachment/procurement/tender/' . $value['lampiran_risiko']); ?>">
                <?= $value['lampiran_risiko'] ?>
              </a>
              </a>
            </td>
            <td>

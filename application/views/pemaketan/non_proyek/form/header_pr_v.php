      ...
      <div class="card-content">
        <div class="card-body">
          ...
          <div class="row">
            <!-- left side -->
            <div class="col-md">
              <div class="col-md-12 form-group row"> <?php $curval = (isset($permintaan['pr_number'])) ? $permintaan['pr_number'] : "AUTO"; ?>
                <label class="col-sm-4 control-label">Nomor Paket</label>
                <div class="col-sm-8">
                  <p class="form-control-static"> : <?php echo $curval ?> </p>
                </div>
              </div>
              <div class="col-md-12 form-group row"> <?php $curval = (isset($permintaan['pr_requester_name'])) ? $permintaan['pr_requester_name'] : $userdata['complete_name']; ?>
                <label class="col-sm-4 control-label">Buyer</label>
                <div class="col-sm-8">
                  <p class="form-control-static"> : <?php echo $curval ?> </p>
                </div>
              </div>
              <div class="col-md-12 form-group row"> <?php $curval = (isset($permintaan['pr_requester_pos_name'])) ? $permintaan['pr_requester_pos_name'] : $pos['dept_name']; ?>
                <label class="col-sm-4 control-label">Divisi/Departemen</label>
                <div class="col-sm-8">
                  <p class="form-control-static"> : <?php echo $curval ?> </p>
                </div>
              </div>
              <div class="col-md-12 form-group row mb-1"> <?php $curval = (isset($permintaan['pr_requester_name'])) ? $permintaan['pr_requester_name'] : $userdata['complete_name']; ?>
                ...
                <div class="col-sm-8"> <?php
                  ...
                  ?> <select name="tipe_pengadaan" id="tipe_pengadaan" class="form-control bg-select" required onchange="tipePengadaan()">
                    <option value="">Pilih tipe pengadaan</option> <?php foreach ($tipe_pengadaan as $key => $value) {
              ...
              <div class="col-md-12 form-group row mb-1 proyek">
                ...
                <div class="col-sm-8 position-relative">
                  <div class="is_sap">
                    ...
                    <button type="button" data-id="perencanaan_pengadaan_inp" data-url="<?php echo site_url(PROCUREMENT_PERENCANAAN_PENGADAAN_PATH . '/sap_picker_zpw1') ?>" class="btn btn-info picker perencanaan-pengadaan-inp-c rounded">
                    <i class="fa fa-search"></i>
                  </div>
                  </button>
                  <input type="hidden" name="perencanaan_pengadaan_inp" required="true" value="
										<?php echo $curval ?>" id="perencanaan_pengadaan_inp" />
                </div>
              </div>
              <!-- end -->
              <!-- haqim -->
              ...
              <div class="col-md-12 form-group row mb-1" id="nama_proyek_div">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="nama_pekerjaan" id="nama_proyek" required="true" value="
													<?php echo $curval ?>" disabled>
                </div>
              </div>
              <!-- end -->
            ...
            <div class="col-md"> <?php
              ...
              </div> <?php } ?> <div class="col-md-12 form-group row" hidden> <?php $curval = (isset($permintaan['pr_pagu_anggaran'])) ? $permintaan["pr_pagu_anggaran"] : 0; ?> <label class="col-sm-4 control-label">Total Anggaran</label>
                <div class="col-sm-8">
                  <p class="form-control-static" id="pagu_anggaran"> : <?php echo inttomoney($curval) ?> </p>
                </div>
              </div> <?php $curval = (isset($permintaan['pr_sisa_anggaran'])) ? $permintaan['pr_sisa_anggaran'] : 0 ?>
              <div class="col-md-12 form-group row" hidden>
              ...
              </div> <?php $curvalAwal = (isset($permintaans["pr_jadwal_pengadaan_awal"])) ? date("Y-m-d", strtotime($permintaans["pr_jadwal_pengadaan_awal"])) : '' ?> <?php $curvalAkhir = (isset($permintaans["pr_jadwal_pengadaan_akhir"])) ? date("Y-m-d", strtotime($permintaans["pr_jadwal_pengadaan_akhir"])) : '' ?> <div class="form-group col-md-12 mb-1 row">
                ...
                <div class="col-sm-8">
                  <div class="input-group date align-items-center">
                    <input type="date" name="tgl_mulai_inp" required class="form-control mr-1" value="
															<?php echo $curvalAwal ?>"> s/d <input type="date" name="tgl_akhir_inp" required class="form-control ml-1" onchange="validateJadwal()" value="
																<?php echo $curvalAkhir ?>">
                  </div>
                </div>
              </div>
              <div class="form-group col-md-12 mb-1 row">
                <label class="col-sm-4 control-label text-bold-700">Metode Pengadaan <span class="text-danger text-bold-700">*</span>
                </label>
                <div class="col-sm-8">
                  <div class="input-group date align-items-center"> <?php
                    ...
                    ?> <select class="form-control bg-select" name="metode_pengadaan" id="metode_pengadaan" required>
                      ...
                      ?> <option <?php echo $selected ?> value="
																		<?php echo $value['val'] ?>"> <?php echo $value['text'] ?> </option> <?php } ?>
                    </select>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-12 form-group mb-1"> <?php $curval = (isset($permintaan['pr_packet'])) ?  $permintaan["pr_packet"] : set_value("nama_paket"); ?> <label class="col-sm-2 control-label">Nama Paket Pengadaan <span class="text-danger text-bold-700">*</span>
              </label>
              <div class="col-sm-10  pr-4" id="nama_paket_div" style="padding-left: 0;">
                <input type="text" class="form-control" name="nama_paket" id="nama_paket" required="true" value="
															<?php echo $curval ?>">
              </div>
            </div>
          </div>
          ...
          <div class="row form-group" hidden="hidden"> <?php $curval = (isset($permintaan['pr_scope_of_work'])) ? $permintaan["pr_scope_of_work"] : set_value("deskripsi_pekerjaan"); ?> <label class="col-sm-2 control-label">Deskripsi Pekerjaan</label>
            <div class="col-sm-10">

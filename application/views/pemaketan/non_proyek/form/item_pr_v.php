          ...
          <div class="row mb-2" id="addSumberDaya" style="display: none;">
            <div class="col-md">
              ...
              <div class="row form-group col-md-12 mb-1">
                ...
                <div class="col-sm-8">
                  ...
                  <div class="btn-group-sm">
                    <button type="button" data-id="kode_item" id="item_int_btn" data-url="<?php echo site_url('procurement/get_picker_sumberdaya_sap') ?>" class="btn btn-info picker sumberdaya_btn">Pilih Sumberdaya</button>
                  </div>
                </div>
              </div>

              <div class="row form-group col-md-12 mb-1" hidden>
                <?php $curval = set_value("ppis_pr_number"); ?>
                <label class="col-sm-4 control-label">PR Number</label>
                <div class="col-sm-8">
                  <p class="form-control-static" id="ppis_pr_number"><?php echo $curval ?></p>
                </div>
              </div>

              <div class="row form-group col-md-12 mb-1" hidden>
                <?php $curval = set_value("pr_item"); ?>
                <label class="col-sm-4 control-label">PR Item</label>
                <div class="col-sm-8">
                  <p class="form-control-static" id="pr_item"><?php echo $curval ?></p>
                </div>
              </div>

              <div class="row form-group col-md-12 mb-1" hidden>
                <?php $curval = set_value("pr_type_sap"); ?>
                <label class="col-sm-4 control-label">Pr Type Sap</label>
                <div class="col-sm-8">
                  <p class="form-control-static" id="pr_type_sap"><?php echo $curval ?></p>
                </div>
              </div>

              <div class="row form-group col-md-12 mb-1" hidden>
                <?php $curval = set_value("delivery_date"); ?>
                <label class="col-sm-4 control-label">Delivery Date</label>
                <div class="col-sm-8">
                  <p class="form-control-static" id="delivery_date"><?php echo $curval ?></p>
                </div>
              </div>
              
              <div class="row form-group col-md-12 mb-1" hidden>
                <?php $curval = set_value("ppis_cat_tech"); ?>
                <label class="col-sm-4 control-label">Cat Tech</label>
                <div class="col-sm-8">
                  <p class="form-control-static" id="ppis_cat_tech"><?php echo $curval ?></p>
                </div>
              </div>

              <div class="row form-group col-md-12 mb-1" hidden>
                <?php $curval = set_value("ppis_acc_assig"); ?>
                <label class="col-sm-4 control-label">Acc Assig</label>
                <div class="col-sm-8">
                  <p class="form-control-static" id="ppis_acc_assig"><?php echo $curval ?></p>
                </div>
              </div>
              ...
              <div class="row form-group col-md-12 mb-1">
                ...
                <div class="col-sm-8">
                  <input readonly type="text" class="form-control money" maxlength="40" name="harga_satuan_item_inp" id="harga_satuan_item_inp" value="<?php echo $curval ?>">
                  <small>
            ...
            <div class="col-md">
              ...
              <div class="row form-group col-md-12 mb-1">
                ...
                <div class="col-sm-8">
                  <select class="form-control bg-select" name="incoterm" id="incoterm">
                    ...
                    <?php foreach($adm_incoterm as $val_in) { ?>
                      <option value="<?php echo $val_in['description']; ?>"><?php echo $val_in['code'] . ' - ' . $val_in['description']; ?></option>
                    <?php } ?>
              ...
              <div class="row form-group col-md-12 mb-1">
                <?php $curval = set_value("sumber_hps"); ?>
              ...
              <div class="row form-group col-md-12">
                ...
                <?php $curval = set_value("doc_attachment_inp_smbd_pmcs[$k]"); ?>
                <div class="col-sm-8">
                  <div class="input-group">
                    <span class="input-group-btn">
                      <button type="button" data-id="doc_attachment_inp_smbd_pmcs" data-folder="pemaketan" data-preview="preview_file" class="btn btn-info upload rounded">
                        <i class="fa fa-cloud-upload"></i> Up
                      </button>
                      <button type="button" data-url="<?php echo site_url('log/download_attachment/pemaketan/' . $curval) ?>" class="btn btn-info preview_upload rounded mr-1" id="preview_file">
                        <i class="fa fa-share"></i> View
                      </button>
                    </span>
                    <input readonly type="text" class="form-control" id="doc_attachment_inp_smbd_pmcs" name="doc_attachment_inp_smbd_pmcs" value="<?php echo $curval ?>">
                    <span class="input-group-btn">
                      <button type="button" data-id="doc_attachment_inp_smbd_pmcs" data-folder="pemaketan" data-preview="preview_file" class="btn btn-danger removefile rounded ml-1">
...
<script type="text/javascript">
    ...
    if ($('#kode_spk').val() == '') {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          $("#ppis_pr_number").html(mydata.ppis_pr_number);
          $("#pr_item").html(mydata.ppis_pr_item);
          $("#delivery_date").html(mydata.ppis_delivery_date);
          $("#ppis_cat_tech").html(mydata.ppis_cat_tech);
          $("#ppis_acc_assig").html(mydata.ppis_acc_assig);
          $("#pr_type_sap").html(mydata.ppis_pr_type);
  ...
  $(document).ready(function() {
    ...
    $(".action_item_sumberdaya").click(function() {
      ...
      var ppis_pr_number = $('#ppis_pr_number').text();
      var pr_item = $('#pr_item').text();
      var delivery_date = $('#delivery_date').text();
      var ppis_cat_tech = $('#ppis_cat_tech').text();
      var ppis_acc_assig = $('#ppis_acc_assig').text();
      var pr_type_sap = $('#pr_type_sap').text();
      ...
      var doc_attachment_inp_smbd_pmcs = $('#doc_attachment_inp_smbd_pmcs').val();
      ...
      if (harga_satuan_int < 1) {
        ...
        alert("Jumlah tidak boleh kurang dari 1");
          ...
          html += "<td><input type='hidden' class='pr_item' data-no='" + no + "' name='pr_item[" + no + "]' value='" + pr_item + "'/>" + pr_item + "</td>";
          html += "<td><input type='hidden' class='pr_type_sap' data-no='" + no + "' name='pr_type_sap[" + no + "]' value='" + pr_type_sap + "'/>" + pr_type_sap + "</td>";
          html += "<td><input type='hidden' class='delivery_date' data-no='" + no + "' name='delivery_date[" + no + "]' value='" + delivery_date + "'/>" + delivery_date + "</td>";
          ...
          html += "<td><input type='hidden' class='doc_attachment_inp_smbd_pmcs' data-no='" + no + "' name='doc_attachment_inp_smbd_pmcs[" + no + "]' value='" + doc_attachment_inp_smbd_pmcs + "'/>"
                  + "<a href='"+ document.location.origin + '/log/download_attachment/pemaketan/' + doc_attachment_inp_smbd_pmcs +"'>"+ doc_attachment_inp_smbd_pmcs + "</a></td>";
          ...
          $('#sumber_hps').val("");
          $('#hps').val("");
          $('#doc_attachment_inp_smbd_pmcs').val("");
          $("#tipe_item").text("");
          $("#max_volume").html("");
          $("#jumlah_item_inp").val("");
          $("#satuan_item_inp").val("");
    ...
    $(document.body).on("click", ".edit_item", function() {
      ...
      var pr_item = $(".pr_item[data-no='" + no + "']").val();
      var pr_type_sap = $(".pr_type_sap[data-no='" + no + "']").val();
      var delivery_date = $(".delivery_date[data-no='" + no + "']").val();
      ...
      var doc_attachment_inp_smbd_pmcs = $(".doc_attachment_inp_smbd_pmcs[data-no='" + no + "']").val();

      $("#current_item").val(no);
      $("#kode_item").val(kode);
      $("#tipe_item").text(tipe);
      $("#ppis_pr_number").text(ppis_pr_number);
      $("#pr_item").text(pr_item);
      $("#pr_type_sap").text(pr_type_sap);
      $("#delivery_date").text(delivery_date);
      $("#ppis_cat_tech").text(ppis_cat_tech);
      $("#ppis_acc_assig").text(ppis_acc_assig);
      ...
      $('#hps').val(hps);
      $('#doc_attachment_inp_smbd_pmcs').val(doc_attachment_inp_smbd_pmcs);

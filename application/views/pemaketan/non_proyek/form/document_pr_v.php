              ...
              <div class="col-sm-8">
                <div class="input-group">
                  <span class="input-group-btn">
                    <button type="button" data-id="doc_attachment_inp_pr_cr" data-folder="pemaketan" data-preview="preview_file_lmprn" class="btn btn-info upload rounded" title="Upload">
                      <i class="fa fa-cloud-upload"></i> Up
                    </button>
                    <button type="button" data-url="<?php echo site_url('log/download_attachment/pemaketan/' . $curval) ?>" class="btn btn-info preview_upload rounded mr-1" id="preview_file_lmprn">
                  ...
                  <span class="input-group-btn">
                    <button type="button" data-id="doc_attachment_inp_pr_cr" data-folder="pemaketan" data-preview="preview_file_lmprn" class="btn btn-danger removefile rounded ml-1">
    ...
    $(".action_save_document").click(function() {
      ...
      if (doc_category_inp == "" || doc_category_inp == null || doc_attachment_inp == "" || doc_desc_inp == "") {
        ...
        html += "<td class='text-left'><input type='hidden' class='doc_attachment_inp_tbl_cr' value=" + doc_attachment_inp + " name='doc_attachment_inp_tbl_cr[" + no + "]' data-no='" + no + "'>" +
          "<a href='" + document.location.origin + '/log/download_attachment/pemaketan/' + doc_attachment_inp + "'>" + doc_attachment_inp + "</a></td>";

            ...
            <div class="col-md">
              ...
              <div class="col-md-12 form-group row mb-1">
                ...
                <div class="col-sm-8 position-relative">
                  ...
                  <button type="button" data-id="perencanaan_pengadaan_inp" data-url="<?php echo site_url(PROCUREMENT_PERENCANAAN_PENGADAAN_PATH . '/picker') ?>" class="btn btn-info picker perencanaan-pengadaan-inp-c rounded"><i class="fa fa-search"></i></button>
              ...
              <div class="form-group col-md-12 mb-1 row">
                ...
                <div class="col-sm-8">
                  <div class="input-group date align-items-center">
                    <?php
                    $jenis_kontrak = [
                      ['val' => 'Kontrak Payung', 'text' => 'Kontrak Payung'],
                      ['val' => 'Spot', 'text' => 'Spot'],
                    ];
                    $curval = (isset($permintaans['pr_jenis_kontrak'])) ? $permintaans['pr_jenis_kontrak'] : '';
                    ?>
                    <select class="form-control bg-select" name="jenis_kontrak" id="jenis_kontrak" required>
                      <option value="">Pilih jenis kontrak</option>
                      <?php foreach ($jenis_kontrak as $key => $value) {
                        $selected = ($curval == $value['val']) ? "selected" : "";
                      ?>
                        <option <?php echo $selected ?> value="<?php echo $value['val'] ?>"><?php echo $value['text'] ?></option>
                      <?php } ?>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    <?php  } else { ?>
      ...
      $("#kode_spk_div").hide();
    <?php } ?>
    var item_int_btn_url = "<?php echo site_url('Paket_pengadaan/get_picker_sumberdaya') ?>";
    if ($('#kode_spk').val() != '') {

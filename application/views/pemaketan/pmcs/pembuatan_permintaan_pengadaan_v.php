<div class="wrapper wrapper-content animated fadeInRight">
  <form method="post" action="<?php echo site_url($controller_name . "/paket_proyek_pmcs/submit_pmcs"); ?>" class="form-horizontal ajaxform">

    <?php
    foreach ($content as $key => $value) {
      include(VIEWPATH . "pemaketan/pmcs/" . $value['awc_type'] . "/" . $value['awc_file'] . ".php");
    }
    ...
    <div class="card">
      <div class="card-content">
        <div class="card-body">
          <?php echo buttonsubmit('paket_pengadaan/paket_proyek_pmcs', lang('back'), lang('save')) ?>
        </div>
      </div>
    </div>

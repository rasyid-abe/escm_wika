                ...
                <div class="col-sm-8">
                  <div class="input-group">
                    <span class="input-group-btn">
                      <button type="button" data-id="doc_attachment_inp_smbd_pmcs" data-folder="procurement/tender" data-preview="preview_file" class="btn btn-info upload rounded">
                    ...
                    <span class="input-group-btn">
                      <button type="button" data-id="doc_attachment_inp_smbd_pmcs" data-folder="procurement/tender" data-preview="preview_file" class="btn btn-danger removefile rounded ml-1">
    ...
    $(".action_item_sumberdaya").click(function() {
      ...
      if (harga_satuan_int < 1) {
        ...
        html += "<td><input type='hidden' class='doc_attachment_inp_smbd_pmcs' data-no='" + no + "' name='doc_attachment_inp_smbd_pmcs[" + no + "]' value='" + doc_attachment_inp_smbd_pmcs + "'/>" +
          "<a href='" + document.location.origin + '/log/download_attachment/procurement/tender/' + doc_attachment_inp_smbd_pmcs + "'>" + doc_attachment_inp_smbd_pmcs + "</a></td>";

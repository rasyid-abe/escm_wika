            ...
            <div class="card-content">
              <div class="card-body">
                  ...
                  <div class="row form-group">
                      ...
                      <a href="<?php echo base_url()."index.php/privy/save_doc/".$id; ?>" class="btn btn-info btn-sm" style="margin: 5px;font-size:11px;"><i class="ft ft-upload"></i> Get PDF E-sign</a>
                    </div>
                  </div>
...
<script>
    ...
    function fSendRequest () 
    {
        ...
        var url = '<?= base_url() ?>' + 'index.php/privy/sign_in_doc_request/'+id+'/'+privy;
        $.ajax({
            type: "GET",
            url: url,
            dataType: "JSON",
    ...
    function fSendProcess() 
    {
        var id = '<?= $id ?>';
        var privy  = '<?= $privy ?>';
        var url = '<?= base_url() ?>' + 'index.php/privy/sign_in_doc_process/'+id;
        var otp = $("#otp").val();
        $.ajax({
            type: "GET",
            url: url + '/' +otp+'/'+privy,
            ...
            success: function (response) {
                if(response.status == "SUCCESS"){
                    ...
                    window.open("<?= base_url() ?>"+"index.php/procurement/pdf_bakp/"+id);

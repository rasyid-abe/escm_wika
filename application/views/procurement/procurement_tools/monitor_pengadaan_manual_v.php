  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-header border-bottom pb-2">
        <h4 class="card-title float-left">Daftar Pengadaan</h4>
        <a href="<?php echo site_url('contract/manual_sap'); ?>" class="btn btn-info btn-sm float-right" title="Create Tender Manual"><i class="ft-plus"></i> Create Tender Manual</a>
      </div>
...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $table_monitor_pengadaan.bootstrapTable({
      ...
      url: "<?php echo site_url('Procurement/data_monitor_pengadaan_manual') ?>",

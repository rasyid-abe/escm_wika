        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md">
              ...
              <!-- end -->
              <?php $curval = (isset($permintaans['pr_doc_type'])) ? $permintaans["pr_doc_type"] : set_value("pr_doc_type"); ?>
              <div class="form-group row col-md-12">
                ...
                <div class="col-sm-8 styleSelect">
                    <select class="form-control bg-select" required name="pr_doc_type" value="<?php echo $curval ?>">
                        ...
                        <?php foreach ($doc_type as $k => $v):  $selected = ($curval == $v['code']) ? "selected" : ""; ?>
                            <option <?php echo $selected ?> value="<?php echo $v['code'] ?>"><?php echo $v['code'].' - '.$v['description'] ?></option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="col-md-12 form-group mb-1 mt-2"> <?php $curval = (isset($permintaan['pr_packet'])) ?  $permintaan["pr_packet"] : set_value("nama_paket"); ?> <label class="col-sm-2 control-label">Nama Paket Pengadaan <span class="text-danger text-bold-700">*</span>
              </label>

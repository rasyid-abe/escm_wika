                ...
                <span class="wrapper-header">
                    ...
                    <div class="wrapper-button" id="btnSaveRisikoDetail" style="display: none;">
                        <span class="wrapper-action save-comment">
                            ...
                            <input type="hidden" id="detail_id_edit">
                        </span>
                    </div>
                </span>
...
<script>
    ...
    $('.action_detail_item').click(() => {
        ...
        var id_db = "";
        if ($('#detail_id_edit').val()) {
            id_db = $('#detail_id_edit').val();
        }
        ...
        if (rsd_item_tbl === '' || rsd_item_tbl === null || rsd_volume === '' || rsd_satuan === '' || rsd_keterangan === '') {
            ...
            let html = "<tr>"
            html += "<td><input type='hidden' class='id_detail_item' data-no='" + no + "' name='id_detail_item[" + no + "]' value='" + id_db + "' />" + no + "</td>"
    ...
    $(document.body).on("click", ".edit_detail_item", function() {
        ...
        if ($(".id_detail_item[data-no='" + no + "']").val()) {
            var id = $(".id_detail_item[data-no='" + no + "']").val();
            $('#detail_id_edit').val(id)
        }
        let rsd_keterangan = $(".rsd_keterangan_tbl[data-no='" + no + "']").val()
        let rsd_volume = $(".rsd_volume_tbl[data-no='" + no + "']").val()
        let rsd_satuan = $(".rsd_satuan_tbl[data-no='" + no + "']").val()
        let rsd_harga_satuan = $(".rsd_harga_satuan_tbl[data-no='" + no + "']").val()

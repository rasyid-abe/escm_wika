            ...
            <div class="row mb-2">
              <div class="col-md">
                <div class="row form-group col-md-12 mb-1">
                  ...
                  <div class="col-md-8">
                    <input type="hidden" class="form-control" name="opp_id" id="opp_id">
            ...
            <tbody>
              ...
              ?>
                  <tr>
                    ...
                    <td>
                      <button type='button' class='btn btn-info btn-xs edit_item_opportunity' data-no="<?= $numb ?>">
  ...
  $(document).ready(function() {
    $('#action_opportunity').click(function() {
      ...
      if (opp_pengusul == '' ||
        ...
        var html = "<tr><td><input type='hidden' class='pengusul' data-no='" + no + "' name='pengusul[" + no + "]' value='" + opp_pengusul + "'/><input type='hidden' class='id_opportunity' data-no='" + no + "' name='id_opportunity[" + no + "]' value='" + opp_id + "' />" + opp_pengusul + "</td>";
    ...
    $(document.body).on("click", ".edit_item_opportunity", function() {
      ...
      if ($(".id_opportunity[data-no='" + no + "']").val()) {
        var id = $(".id_opportunity[data-no='" + no + "']").val();
        $('#opp_id').val(id);
      }

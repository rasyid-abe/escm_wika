        ...
        <div class="card-content">
          <div class="card-body" style="margin-bottom: -30px;">            
            <table class="table table-striped table-responsive">
              ...
              <tbody>
                ...
                <?php
                    ...
                    <tr>
                      <td class="text-bold-700" colspan="40" align="center">No data</td>
                    </tr>
                <?php } ?>
            ...
            <div class="row form-group">
              ...
              <label class="col-sm-3 control-label text-right">Total RAB</label>
              <div class="col-sm-3">
            ...
            <?php if($permintaan['isjoin'] != 1) { ?>
              <div class="row form-group">
                ...
                <label class="col-sm-3 control-label text-right">Total HPS</label>
                <div class="col-sm-3">
                  <p class="form-control-static text-right"><?php echo inttomoney($subtotalhps); ?></p>
                </div>
              </div>
            <?php } ?>
          </div>

          ...
          <div class="card" style="border-radius: 30px;">
            <div class="card-body">
              <div class="table-responsive">
                <a href="#" class="btn btn-info btn-lg" style="margin-bottom: -65px;"><i class="ft ft-file"></i> Tambah</a>
                <table id="table_perencanaan_non_pmcs" class="table m-0"></table>
                <a href="<?= site_url() ?>" class="btn btn-info"><i class="ft ft-corner-up-left"></i> Kembali</a>
              </div>
            </div>
          </div>
...
<script type="text/javascript">
  ...
  function action(index, row, url) {
    return ['<input class="form-control" type="radio" style="font-size: 2px;" />'].join('');
  }

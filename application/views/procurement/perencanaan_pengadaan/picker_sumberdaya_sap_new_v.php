...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $table.bootstrapTable({
      ...
      url: "<?php echo site_url('Procurement/get_item_perencanaan_sap')."?spk_code=".$spk_code ?>",
      cookieIdTable:"picker_sumberdaya",
      idField:"ppis_pr_number",
...
function getIdSelections() {
  return $.map($table.bootstrapTable('getSelections'), function (row) {
    return row.ppis_pr_number
  });
}
function responseHandler(res) {
  $.each(res.rows, function (i, row) {
    row.state = $.inArray(row.ppis_pr_number, selections) !== -1;
  });
  return res;
}

      ...
      <div class="card float-e-margins">
        ...
        <div class="card-content">
          ...
          <div class="input-group-btn" style="margin-bottom: -45px;">
            ...
            <a href="<?= site_url('administration/template_vpi/penilaian_penyedia_barang/hasil_mutu_pekerjaan') ?>" disabled type="button" class="btn btn-info">
...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $table.bootstrapTable({
      ...
      url: "<?= site_url('administration/template_vpi/penilaian_penyedia_barang/hasil_mutu_pekerjaan/data_hasil_mutu_pekerjaan') ?>",

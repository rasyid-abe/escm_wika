    ...
    <div class="col-lg-12">
      <div class="card float-e-margins">
        <div class="card-title">
          <h5>Katalog Semua Sumberdaya</h5>
        </div>
...
<script type="text/javascript">
  ...
  $(function () {
    ...
    $table.bootstrapTable({
      ...
      url: "<?php echo site_url('Commodity/data_kat_smbd/approved') ?>",
      cookieIdTable:"kat_all_smbd",
      idField:"catalog_code",
...
function getIdSelections() {
  return $.map($table.bootstrapTable('getSelections'), function (row) {
    return row.catalog_code
  });
}
function responseHandler(res) {
  $.each(res.rows, function (i, row) {
    row.state = $.inArray(row.catalog_code, selections) !== -1;
  });
  return res;
}

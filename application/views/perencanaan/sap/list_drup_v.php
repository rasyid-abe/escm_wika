                ...
                <div class="row justify-content-end mb-2">
                    ...
                    <div class="col-sm-8 mb-2">
                        <div class="row">
                            ...
                            <div class="col-sm-3 styleSelect" id="selprtype">
                            ...
                            <div class="col-sm-3 styleSelect" id="selnopr">
        ...
        $.each(data.result, function(i,v) {
            ...
            $.each(items, function(id, va) {
                ...
                <tr>
                    ...
                    <td class="text-center">${v.dep_code}, ${v.dept_name}</td>
                    ...
                    <td class="text-center">${v.ppms_finish_date}</td>
                    <td class="text-center">${stst}</td>
                </tr>
                `
            ...
            row += `
            <tr class="header">
                <td class="text-left" colspan="14" style="font-weight:bold;">
                &nbsp;&nbsp;${v.ppis_pr_type}, ${v.ppm_project_id}, Project Def : ${v.ppm_subject_of_work}, TCM : ${formatter.format(stt)} , Total Cost Plan BL : Rp. 0
                </td>
            </tr>
            ${itr}
            `

    ...
    <div class="col-12">
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <form id="myFormId" action="<?php echo base_url('perencanaan_pengadaan/export_pmcs') ?>" method="post">
...
<script type="text/javascript">
    ...
    function data_rencana_pengadaan(fil) {
        ...
        $.ajax({
            url: '<?php echo base_url('perencanaan_pengadaan/data_rencana_pengadaan') ?>',
            method: 'post',
            data: send,
            dataType: 'json',

        ...
        <div class="row">
            <div class="col-sm-12 table-responsive">
                <table style="width: 100%">
                    ...
                    <tr>
                        <td><h6>Tanggal :</h6></td>
                        <td><input type="date" name="tgl_bakp" class="form-control form_header" value="<?php echo date('Y-m-d') ?>" /></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <h6>Pada hari ini, <input type="text" name="hari" value="<?= strtolower($this->terbilang->hari_indo(date('D'))); ?>">
                                tanggal <input type="text" name="tanggal" value="<?php echo strtolower($this->terbilang->eja(date('d'))) ?>">
                                bulan <input type="text" name="bulan" value="<?php echo date('F') ?>">
                                tahun <input type="text" name="tahun" value="<?php echo strtolower($this->terbilang->eja(date('Y'))) ?>">
                                ( <input type="date" name="fultgl" value="<?php echo date('Y-m-d') ?>"> )
                                di <input type="text" name="tempat" value="<?php echo !empty($data_uskep['bakp_city']) ? $data_uskep['bakp_city'] : 'Jakarta' ?>"> telah dilaksanakan <br>
                    ...
                    <tr>
                        ...
                        <td class="bold">Nilai RAB/Cosplan</td>
                ...
                <!-- <table style="width: 100%" class="table-striped table">
                    <tr>
                        <th colspan="3" class="ml-3">
                            E-Sign
                            <span id="addesign" class="ml-2 btn-sm btn btn-info"onclick="add_esign()"><i class="ft ft-plus"></i></span></th>
                        <th colspan="3"></th>
                    </tr>
                </table> -->

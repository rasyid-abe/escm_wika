...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <form method="post" action="<?php echo site_url($controller_name."/submit_dsp");?>"  class="form-horizontal ajaxform">
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <div class="col-sm-10 mb-2">
                        <input type="text" class="form-control" name="paketPengadaan" id="paketPengadaan" placeholder="Paket Pengadaan">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10 mb-2">
                        <select class="form-control select2" name="project" id="project">
                            ...
                            <?php foreach($projects as $key => $val){ ?>
                                <option value='<?php echo $val['kode_spk']; ?>' <?php echo $k_spk == $val['kode_spk'] ? 'selected' : '' ?>><?php echo $val['nama_spk']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
        ...
        <table id="esigntbl" style="width: 100%" class="table table-striped m-0 hidden">
            ...
            <tr id="">
                ...
                <input type="hidden" name="nipemploy" id="nipemploy" value="">
                <input type="hidden" name="hpemploy" id="hpemploy" value="">
                <td>
                    <select style="width: 300px" class="form_header select2" id="nmKew" name="nm_kew" disabled>
                        <option value="">Nama</option>
                    </select>
                </td>
                <td><input type="text" class="form_header form-control" name="fun_bidang" value="" id="fun_bidang" readonly></td>
                <td><input type="text" class="form_header form-control" name="job_title" value="" id="job_title" readonly></td>
                <td><input type="text" class="form_header form-control" name="tempat" value="Jakarta"></td>
                <td><input type="date" class="form_header form-control" name="tanggal_ttd" value="<?php echo date('Y-m-d') ?>"></td>
            </tr>
        </table>
        <div id="required" class="card hidden">
            <div class="card-content">
                <div class="card-body">
                    <?= buttonsubmit('#',lang('back'),lang('save')) ?>
                </div>
            </div>
        </div>

            ...
            <div class="col-sm-12">
                <div id="tbl_inp_dpkn" class="table-responsive">
                    <table style="width: 100%" class="table-striped" id="tbl_dpkn">
                        ...
                        <!-- <pre> -->
                        <?php
                        // print_r($poin_penawaran);
                        // die;

                        foreach ($poin_penawaran as $k => $va):
                            ?>
                            <tr id="pen_p<?= $k ?>" class="itemsa">
                                ...
                                <td class="text-right">
                                    <span id="lblharsat_p<?= $k ?>"><?php echo "Rp " . $va->harga_satuan ?>,00</span>
                        ...
                        <?php foreach ($poin_negosiasi as $k => $va):
                            ...
                            <tr class="sub_pen_p<?= $k ?>">
                                ...
                                <td>
                                    <span id="lblnegoharsat_p<?= $k ?>">Rp. <?php echo $va->harga_satuan ?>,00</span>
                    ...
                    <table style="width: 100%" class="table-striped" id="tbl_esign" border="1">
                        <tr class="hidden">
                            <th colspan="3" class="ml-3">
                                ...
                                <input type="hidden" name="tipe_plan" id="tipePlan" value="<?php echo $tipe_proyek ?>">
                                <input type="hidden" name="catmanagement" id="catmanagement" value="<?php echo $catmanagement ?>">
                                <input type="hidden" name="jnspengadaan" id="jnspengadaan" value="<?php echo $jnspengadaan ?>">
                                <input type="hidden" name="tipeProyek" id="tipeProyek" value="<?php echo $nilai ?>">
                            </th>
                        </tr>
                        <tbody id="tr_esign">
                            <tr>
                            ...
                            <?php foreach ($val_esign->nm_kew as $k => $v): ?>
                                <tr>
                                    ...
                                    <td style="width: 300px; text: white;">
    									...
    									<input class="form-control" type="text" name="" value="<?php echo $val_esign->nm_kew[$k] ?>" /readonly>
    									<input class="form-control" type="hidden" name="nm_kew[]" value="<?php echo $val_esign->nip[$k].'_'.$val_esign->nm_kew[$k].'_'.$val_esign->job_title[$k] ?>" />
                                    </td>
                                    <td>

  ...
  <form method="post" id="form_aspek_penilaian_ketepatan_progress" action="<?php echo site_url($controller_name."/vpi/daftar_pekerjaan/penilaian_vpi/".$vvh_id."/barang/submit_ketepatan_progress");?>"  class="form-horizontal">
      ...
      <div class="col-lg-12">
        <div class="card float-e-margins">
          <div class="card-header border-bottom pb-2">
            <h5 class="card-header border-bottom pb-2">Header</h5>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card float-e-margins">
          <div class="card-header border-bottom pb-2">
            <h5 class="card-header border-bottom pb-2">Penilaian *</h5>
              ...
              <div class="col-sm-2">
                ...
                <select name="nilai_akhir_inp" id="nilai_akhir_inp" class="form-control" required>
                  ...
                  <?php foreach ($listNilai as $key => $value) :?>
                    ...
                    <option <?= $selected; ?> value="<?= $value['value'] ?>"> Nilai <?= $value['value'] ?> - <?= $value['desc'] ?></option>
...
<div class="row">
  <div class="col-lg-12">
    <div class="card float-e-margins">
      <div class="card-header border-bottom pb-2">
        <h5 class="card-header border-bottom pb-2">Catatan</h5>
      </div>
      <div class="card-body">

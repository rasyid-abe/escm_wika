...
class Procedure_m extends MY_Model {
	...
	public function __construct(){
		...
		$this->data['employee_id'] = $userdata['employee_id'];
	}
	...
	public function movePRtoRFQ($pr_number){
		...
		$input['ptm_tender_project_type'] = strtoupper($get_pr['pr_type_pengadaan']);
				...
				if($response == url_title('Tunjuk Pelaksana Pekerjaan',"_",true)){
					...
					if(!empty($vnd)){
						...
						if(!$is_matgis){
							...
							$spew = "job_title = 'PENGELOLA KONTRAK' AND district_id = $district_id";
							$or_spew = "job_title = 'PENGELOLA KONTRAK' AND district_id = $district_id";
							$spem = "job_title = 'MANAJER KONTRAK' AND district_id = $district_id";
							$or_spem = "job_title = 'MANAJER KONTRAK' AND district_id = $district_id";
						...
						// $getman = $this->db->get("user_login_rule")->row_array();
						$getspe = $this->db->get("adm_pos")->row_array();
						...
						if(!empty($getspe)){
							...
							$input['ctr_spe_employee'] = $this->data['employee_id'];
						...
						if(!empty($getman)){
							...
							$input['ctr_man_employee'] = $this->data['employee_id'];

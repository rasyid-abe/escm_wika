                            ...
                            <div class="card mt-4">
                                <div class="card-content">
                                    <div class="card-body text-center py-4">
                                        <span class="badge badge-success py-2 px-4 font-medium-3 text-wrap" style="max-width: 100%;">Data sudah disimpan dan email validasi sudah dikirim ke email Anda.</span>
                                    </div>
                                </div>
                            </div>

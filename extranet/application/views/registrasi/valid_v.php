                    ...
                    <div class="content-wrapper">    
                        <section class="timeline-left timeline-wrapper col-sm-10 col-12 offset-sm-1">
                            <div class="row text-center pt-5">
                                <div class="col-12">
                                    <h3 class="text-center title-main"><?php echo $title; ?> Berhasil</h3>
                                </div>
                            </div>
                            <div class="card mt-4">
                                <div class="card-content">
                                    <div class="card-body text-center py-4">
                                        <span class="badge badge-success py-2 px-4 font-medium-3 text-wrap" style="max-width: 100%;">Validasi email telah berhasil, silakan login untuk melanjutkan registrasi</span>
                                    </div>
                                </div>
                            </div>

	...
	<div class="match-height">
		<form class="form-bordered">
			...
			<div class="col-lg-12 text-center my-3">
				<a href="<?php echo site_url('registrasi_perorangan/utama'); ?>" class="btn btn-secondary btn-md">Kembali</a>
				<a href="<?php echo site_url('registrasi_perorangan/pengalaman_cv'); ?>" class="btn btn-info btn-md">Selanjutnya</a>
			</div>
		</form>
	</div>
	<!-- Table ends -->

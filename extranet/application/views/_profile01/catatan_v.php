...
<section class="bordered-striped-form-layout">
    ...
    <div class="match-height">
                                ...
                                <div class="form-group row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative">
                                            ...
                                            <?php echo form_hidden('file_lama', $detail_vendor['vendor_lampiran']); ?>                                                                                     
                                            <?php if ($detail_vendor['vendor_lampiran'] != NULL) { ?>
                                                <div class="btn-group btn-group-sm">
                                                    <?php if ($detail_vendor['reg_status_id'] != 8 && $detail_vendor['reg_status_id'] != 14) { ?>
                                                        <a class="btn btn-danger" href="<?php echo site_url('registrasi_vendor/delete_vendor_lampiran/') . $detail_vendor['vendor_lampiran']?>" onclick="return confirm('Apakah Anda yakin hapus file ini?')">Delete</a>
                                                    <?php } ?>
                                                    <a class="btn btn-success" href="<?php echo base_url('attachment/vendor/' . $detail_vendor['vendor_id'] . '/') . $detail_vendor['vendor_lampiran']?>" target="_blank">View</a>
                                                </div>
                                            <?php } ?>
                                        </div>
                                    </div>
        ...
        <form method="POST" action="<?php echo site_url('registrasi_vendor/submit_comment');?>" enctype="multipart/form-data">                                    
            <!-- form komentar -->
            <div class="row">
                <div class="col-12">
                    <div class="card">
            ...
            <div class="col-lg-12 text-center my-3">
                <a href="<?php echo site_url('registrasi_vendor/cqsms');?>" class="btn btn-secondary btn-md" >Kembali</a>
                <?php if ($detail_vendor['reg_status_id'] != 8 && $detail_vendor['reg_status_id'] != 14) { ?>

						...
						<tbody>
							<?php 
								...
								<tr>
									...
									<td><?php echo number_format($row["tit_quantity"]) ?></td>
				...
				<div class="card-content">
					<div class="card-body">
						<form action="<?php echo site_url('pengadaan/daftar') ?>" method="POST" enctype='multipart/form-data'>
							...
							<div class="row form-group d-flex justify-content-center py-2"><label class="col-sm-2 control-label text-center"><?php echo $this->lang->line('Jawaban'); ?></label>
								<div class="col-sm-2 m-l-n">
									<select class="form-control m-b" id="response" name="response" required>
							...
							<div class="row form-group d-flex justify-content-center">
								<button class="btn btn-info mr-1" type="submit"><?php echo $this->lang->line('Kirim'); ?></button>
								<button class="btn btn-secondary" onclick="history.go(-1)"><?php echo $this->lang->line('Kembali'); ?></button>																
							</div>
						</form>
					</div>
				</div>

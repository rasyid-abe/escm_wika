          ...
          <table class="table table-bordered" id="item_table">
            <thead>
              <tr>
                ...
                <?php if($state==3 || !$state==2):?>
                  <?php if($mod=='si' || $mod=='sppm' || $mod=='do' || $mod=='sj' || $mod=='bapb'):?>
            ...
            <tbody>
              ...
              foreach ($items as $key => $value) {
                ...
                $this->db->from('ctr_'.$mod.'_item');
                $this->db->where($reff."_id=".$id." AND item_code= '".$value['item_code']."'");
                $max_q = $this->db->get()->row()->qty;
                ...
                <tr>
                  ...
                  <?php endif;?>
                  <td>
                    <?php if($type_form=="view" || $state==2 || $mod=='inv'):?>

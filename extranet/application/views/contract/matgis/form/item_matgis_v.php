            ...
            <tbody>
              ...
              foreach ($items as $key => $value) {
                ...
                <tr>
                  ...
                  <td>
                    <input type="text" class="form-control qty" data-v-max="<?php echo $qty_max;?>" style="width:120px;text-align: right;" name="qty_data[<?php echo $value[$reff.'_item_id'] ?>]" value="<?php echo $qty ?>">
                  </td>
...
function set_total(){
  ...
  $("#item_table tr").each(function(){
    ...
    var qty_max = (!isNaN($(this).find("input.qty_max").val())) ? parseFloat($(this).find("input.qty_max").val()) : 0;
